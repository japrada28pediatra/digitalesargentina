                    ...
                    if (response === 'success') {
                        ...
                        if (actionInput.val() === 'subscribe') {
                            ...
                            if (actionInput.val() === 'appointment') {
                                form.find('.submit_appointment').html('Get Started Now <i class="rtmicon rtmicon-arrow-up-right"></i>');
                        ...
                        $('.submit_form').html('Send Message');
                        $('.submit_subscribe').html('<i class="rtmicon rtmicon-arrow-right"></i>');
                        $('.submit_appointment').html('Get Started Now <i class="rtmicon rtmicon-arrow-up-right"></i>');
                    }
                }
            });
        }
